...
<a href="info_form2.php">Добавить данные</a><br/>
<a href="select2.php">Редактировать данные</a><br/>
<a href="select_delete2.php">Удалить данные</a><br/>
...
<h3>Поиск</h3>
 <form name="search" method="post" action="SelectForm2.php">
    		<input type="search" name="diagnos" placeholder="Поиск по заболеванию">
    		<button type="submit">Найти</button>
		</form>
      <center>
    <table border="1">
    <caption><h1><strong>Объекты исследования</strong></h1></caption>
    <tr><th>id</th><th>Вид рыбы</th><th>Возраст</th><th>Вес</th><th>Длина</th></tr>
  </center>
  <?php
...
while($row = mysqli_fetch_array($result)){
	echo "<tr><td>".$row["ID_fish"]."</td><td>".$row["fish"]."</td><td>".$row["age"]."</td><td>".$row["weight"]."</td><td>".$row["length"]."</td></tr>";
}
