...
<a href="info_form3.php">Добавить данные</a><br/>
<a href="select3.php">Редактировать данные</a><br/>
<a href="select_delete3.php">Удалить данные</a><br/>
...
WebBrowser1.ExecWB(6, 2);//Use a 1 vs. a 2 for a prompting dialog box WebBrowser1.outerHTML = "";
           ...
           <center>
    <table border="1">
    <caption><h1><strong>Место отлова</strong></h1></caption>

    <tr><th>id</th><th>Место отлова</th></tr>
  </center>
  <?php
...
$query = "SELECT * FROM fish_farm";
$result = mysqli_query($db, $query);
while($row = mysqli_fetch_array($result)){
	echo "<tr><td>".$row["ID_fish_farm"]."</td><td>".$row["place"]."</td></tr>";
}
